...
# CHECK-INST: add.n a5, a2, a3
# CHECK: encoding: [0x3a,0x52]
add.n a5, a2, a3
...
# Instruction format RRR
# CHECK-INST: salt a4, a5, a6
# CHECK: encoding: [0x60,0x45,0x72]
salt a4, a5, a6

# Instruction format RRR
# CHECK-INST: saltu a4, a5, a6
# CHECK: encoding: [0x60,0x45,0x62]
saltu a4, a5, a6
