...
; UNOPT-NEXT:    s32i.n a3, a1, 4 # 4-byte Folded Spill
; UNOPT-NEXT:    s32i.n a4, a1, 8 # 4-byte Folded Spill
...
; UNOPT-NEXT:    l32i.n a2, a1, 0 # 4-byte Folded Reload
; UNOPT-NEXT:    addi a1, a1, 12
; UNOPT-NEXT:    ret.n
entry:
...
; UNOPT-NEXT:    s32i.n a4, a1, 8 # 4-byte Folded Spill
; UNOPT-NEXT:    s32i.n a5, a1, 12 # 4-byte Folded Spill
; UNOPT-NEXT:    s32i.n a6, a1, 16 # 4-byte Folded Spill
; UNOPT-NEXT:    s32i.n a7, a1, 20 # 4-byte Folded Spill
; UNOPT-NEXT:    extui a2, a2, 0, 1
; UNOPT-NEXT:    bnez a2, .LBB4_2
; UNOPT-NEXT:    j .LBB4_3
; UNOPT-NEXT:  .LBB4_2: # %cond.true
; UNOPT-NEXT:    l32i.n a2, a1, 12 # 4-byte Folded Reload
...
; UNOPT-NEXT:    l32i.n a2, a1, 20 # 4-byte Folded Reload
; UNOPT-NEXT:    l32i.n a3, a1, 16 # 4-byte Folded Reload
; UNOPT-NEXT:    s32i.n a3, a1, 0 # 4-byte Folded Spill
; UNOPT-NEXT:    s32i.n a2, a1, 4 # 4-byte Folded Spill
; UNOPT-NEXT:    j .LBB4_4
; UNOPT-NEXT:  .LBB4_4: # %cond.end
; UNOPT-NEXT:    l32i.n a2, a1, 0 # 4-byte Folded Reload
; UNOPT-NEXT:    l32i.n a3, a1, 4 # 4-byte Folded Reload
; UNOPT-NEXT:    addi a1, a1, 24
; UNOPT-NEXT:    ret.n
entry:
  br i1 %cnd, label %cond.true, label %cond.false
