...
; CHECK-NEXT:    saltu a7, a4, a3
; CHECK-NEXT:    ssr a4
; CHECK-NEXT:    srl a3, a6
; CHECK-NEXT:    srl a5, a2
; CHECK-NEXT:    neg a8, a4
; CHECK-NEXT:    ssl a8
...
; CHECK-NEXT:    ssr a4
; CHECK-NEXT:    sra a8, a6
; CHECK-NEXT:    moveqz a2, a8, a7
; CHECK-NEXT:    moveqz a2, a5, a4
; CHECK-NEXT:    moveqz a3, a6, a7
; CHECK-NEXT:    ret.n
entry:
