...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    salt a6, a3, a5
; CHECK-NEXT:    saltu a2, a2, a4
; CHECK-NEXT:    sub a3, a3, a5
; CHECK-NEXT:    moveqz a6, a2, a3
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    extui a4, a3, 31, 1
; CHECK-NEXT:    movi.n a5, 1
; CHECK-NEXT:    saltu a2, a2, a5
; CHECK-NEXT:    moveqz a4, a2, a3
...
; CHECK-NEXT:    salt a4, a5, a3
; CHECK-NEXT:    saltu a2, a5, a2
; CHECK-NEXT:    moveqz a4, a2, a3
; CHECK-NEXT:    mov.n a2, a4
; CHECK-NEXT:    ret.n
entry:
