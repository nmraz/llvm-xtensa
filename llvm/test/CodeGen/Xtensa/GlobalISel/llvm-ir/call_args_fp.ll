...
; UNOPT-NEXT:    movi.n a2, 1
; UNOPT-NEXT:    s32i.n a2, a15, 4 # 4-byte Spill
; UNOPT-NEXT:    movi.n a3, 2
; UNOPT-NEXT:    movi.n a4, 3
; UNOPT-NEXT:    movi.n a5, 0
; UNOPT-NEXT:    call0 reg_arg_i64_packed
; UNOPT-NEXT:    l32i.n a2, a15, 4 # 4-byte Reload
...
; OPT-NEXT:    s32i.n a15, a1, 24 # 4-byte Spill
; OPT-NEXT:    mov.n a15, a1
; OPT-NEXT:    s32i.n a0, a1, 28 # 4-byte Spill
; OPT-NEXT:    s32i.n a12, a1, 20 # 4-byte Spill
; OPT-NEXT:    s32i.n a13, a1, 16 # 4-byte Spill
...
; OPT-NEXT:    l32i.n a13, a1, 16 # 4-byte Reload
; OPT-NEXT:    l32i.n a12, a1, 20 # 4-byte Reload
; OPT-NEXT:    l32i.n a0, a1, 28 # 4-byte Reload
; OPT-NEXT:    mov.n a1, a15
; OPT-NEXT:    l32i.n a15, a1, 24 # 4-byte Reload
; OPT-NEXT:    addi a1, a1, 32
; OPT-NEXT:    ret.n
;
...
; UNOPT-NEXT:    movi.n a2, 1
; UNOPT-NEXT:    s32i.n a2, a15, 16 # 4-byte Spill
; UNOPT-NEXT:    movi.n a3, 2
; UNOPT-NEXT:    s32i.n a3, a15, 20 # 4-byte Spill
; UNOPT-NEXT:    movi.n a4, 3
; UNOPT-NEXT:    s32i.n a4, a15, 24 # 4-byte Spill
; UNOPT-NEXT:    movi.n a5, 4
; UNOPT-NEXT:    s32i.n a5, a15, 28 # 4-byte Spill
; UNOPT-NEXT:    movi.n a6, 5
; UNOPT-NEXT:    s32i.n a6, a15, 32 # 4-byte Spill
; UNOPT-NEXT:    movi.n a7, 6
; UNOPT-NEXT:    s32i.n a7, a15, 36 # 4-byte Spill
; UNOPT-NEXT:    call0 stack_arg_i32
; UNOPT-NEXT:    l32i.n a2, a15, 16 # 4-byte Reload
; UNOPT-NEXT:    l32i.n a3, a15, 20 # 4-byte Reload
; UNOPT-NEXT:    l32i.n a4, a15, 24 # 4-byte Reload
; UNOPT-NEXT:    l32i.n a5, a15, 28 # 4-byte Reload
; UNOPT-NEXT:    l32i.n a6, a15, 32 # 4-byte Reload
; UNOPT-NEXT:    l32i.n a7, a15, 36 # 4-byte Reload
...
; OPT-NEXT:    s32i.n a15, a1, 40 # 4-byte Spill
; OPT-NEXT:    mov.n a15, a1
; OPT-NEXT:    s32i.n a0, a1, 44 # 4-byte Spill
; OPT-NEXT:    s32i.n a12, a1, 36 # 4-byte Spill
; OPT-NEXT:    s32i.n a13, a1, 32 # 4-byte Spill
; OPT-NEXT:    s32i.n a14, a1, 28 # 4-byte Spill
...
; OPT-NEXT:    l32i.n a14, a1, 28 # 4-byte Reload
; OPT-NEXT:    l32i.n a13, a1, 32 # 4-byte Reload
; OPT-NEXT:    l32i.n a12, a1, 36 # 4-byte Reload
; OPT-NEXT:    l32i.n a0, a1, 44 # 4-byte Reload
; OPT-NEXT:    mov.n a1, a15
; OPT-NEXT:    l32i.n a15, a1, 40 # 4-byte Reload
; OPT-NEXT:    addi a1, a1, 48
; OPT-NEXT:    ret.n
;
